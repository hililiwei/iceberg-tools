...
/**
 * Command-line "avro-tools" utilities should implement this interface for delegation by {@link
 * Main}.
 */
public interface Tool {
    /**
     * Runs the tool with supplied arguments. Input and output streams are customizable for easier
     * testing.
     *
